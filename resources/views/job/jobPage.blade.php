                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" data-period="2000" style="font-size: 1.8rem"
                            data-rotate='[ "CAREER", "CAREER", "CAREER", "CAREER", "CAREER" ]'></span>
                    </h1>
                    <p><a class="" style="color: #594671;font-size: 0.8em;"></a></p>
                        ...
                        <div class="card-body ">
                            ...
                            <form action="{{ route('job') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">Applicant name</label>
        
                                            <input style="background: transparent;" type="text" name="name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="email" name="email"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="phone" name="phone"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="text" name="education"
                                                class="form-control" placeholder="Enter your Education" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="" class="form-label"> Select Job Profile</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">Total Experience</label>
                                            <select name="exp" id="" class="form-control" required>
                                                ...
                                                <option value="5++_year">5+ year</option>
                                            </select>
                                        </div>       
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="text" name="location"
                                                class="form-control" placeholder="Enter Current Location" required>
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="name">Current Organization name(Optional)</label>

                                    <input style="background: transparent;" type="text" name="company_name"
                                        class="form-control" placeholder="Enter your Company name">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label" for="message">About yourself</label>

                                    <textarea style="background: transparent;" required name="message"
                                        class="form-control" placeholder="Tell us about yourself" id="" cols="10"
                                        rows="5"></textarea>
