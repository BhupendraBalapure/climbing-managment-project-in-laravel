            ...
            <div class="col-md-5">
                ...
                <div class="item-pro">
                    ...
                    <p style="text-align: justify">
                        <a class="" style="color: #594671;font-size: 0.8em;">
                            Position :- Relationship Executive <br>
                            Location :- Nagpur <br>
                            Salary &nbsp;&nbsp;:-15,000 <br><br>
                            Work Description :- <br>
                                •To sale HDFC Credit Card <br>
                                • Field sales Work <br>
                                • Generate New Lead <br>
                        </a>
                    </p>
                ...
                <div class="cont " style="margin-top: 6rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            @endif
                            <br>
                            <form action="{{ route('career') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">First name</label>
                                            <input style="background: transparent;" type="text" name="first_name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="text" name="last_name"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">Current Education</label>

                                            <input style="background: transparent;" type="text" name="education"
                                                class="form-control" placeholder="Enter your current Education"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input style="background: transparent;" type="text" name="location"
                                                class="form-control" placeholder="Enter your Location" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid">
