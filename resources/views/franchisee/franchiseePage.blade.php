                ...
                <div class="item-pro">
                    ...
                    <h1>
                        ...
                        <span class="txt-rotate" data-period="2000" style="font-size: 1.8rem"
                            data-rotate='[ "FRANCHISEE", "FRANCHISEE", "FRANCHISEE", "FRANCHISEE", "FRANCHISEE" ]'></span>
                    </h1>
                    <p><a class="" style="color: #594671;font-size: 0.8em;">To Be Referred As The Most Favorable Company In Credit Card And Loan
                            Products , Our Objective Is To Became One Of The Leading Market Share Holder In One Of The
                            Most Competitive Market In The World.</a></p>
                ...
                <div class="cont " style="margin-top: 6rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{ route('franchisee') }}" method="post">
                                @csrf
                                {{-- <input type="hidden" name="_token" value="jDOLkYs2kdFOX3onaqPKJa2UScaMWzxMEIl4ThPT"> --}}
                                {{-- <h1>Join us</h1> --}}
                                <br>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="name">Company Name (If Any)</label>
                                    <input type="company_name" name="company_name" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="phone" name="phone" class="form-control" placeholder="Enter Number"
