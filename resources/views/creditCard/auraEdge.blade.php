                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "AURA EDGE CREDIT CARD", "AURA EDGE CREDIT CARD", "AURA EDGE CREDIT CARD", "AURA EDGE CREDIT CARD", "AURA EDGE CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/Aura Edge_card-image_396x257px.png')}}" alt="Aura Edge-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            The Platinum Aura Edge credit card offered by IndusInd Bank is a chip-based contactless card. You can make payments that are secure, convenient, and fast.
                        </li> <br>
                        <li>Earn up to 4X Reward Points on select merchant categories, for every ₹ 100 spent. 
                        </li><br>
                        <li>EazyDiner offers table reservation in top 2000 restaurants across 9 Indian cities with a guaranteed meal offer.
                        </li><br>
                        <li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.auraEdge')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Aura-Edge Credit Card" readonly>
                                    </div>
