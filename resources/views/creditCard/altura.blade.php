                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "ALTURA CREDIT CARD", "ALTURA CREDIT CARD", "ALTURA CREDIT CARD", "ALTURA CREDIT CARD", "ALTURA CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{ asset('assets/img/creditCard/Altura-Card.jpg') }}" alt="Altura-Card"
                    ...
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        ...
                        <li> Convert your transactions worth Rs.2,000 or more into easy EMI options on select tenure of
                            your choice. Simply call our Customer Care helpline to book your XpressEMI.
                        </li><br>
                        <li>Offer your Altura Credit Card benefits to your loved ones, through our Add on card offering.
                            What's more? Your Add on card comes free for lifetime! So, go ahead and avail it.
                        </li><br>
                        <li>
                            2 complimentary lounge access per calendar quarter, using VISA Card at railway stations in
                            these cities – New Delhi, Kolkata (Sealdah), Jaipur, Ahmedabad, Agra and Madurai.
                        </li><br>
                        <li>
                            Get additional cashback of Rs.50 on completing a minimum of Rs.10,000 retail spends in every
                            statement cycle.
                        </li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{ route('create.altura') }}" id="form" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col p-3">
                                            <input type="text" style="text-align: center" class="form-control"
                                                name="img_name" value="Altura Credit Card" readonly>
                                        </div>
