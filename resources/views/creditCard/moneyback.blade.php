        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <div class="item-pro">
                    <!-- <h4>Contact Us</h4> -->
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem;text-transform: uppercase;"
                            data-period="2000"
                            data-rotate='[ "MoneyBack CREDIT CARD", "MoneyBack CREDIT CARD", "MoneyBack CREDIT CARD", "MoneyBack CREDIT CARD", "MoneyBack CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{ asset('assets/img/creditCard/money back.webp') }}" alt="MoneyBack-Card"
                            style="width: 50%;height: 50%;">
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            HDFC Bank MoneyBack Credit Card ccomes with an option to convert your big spends into EMI
                            after purchase. To know more
                        </li><br>
                        <li>
                            Enjoy Revolving Credit on your HDFC Bank MoneyBack Credit Card at nominal interest rate.
                        </li> <br>
                        <li> In the unfortunate event of losing your HDFC Bank MoneyBack Card, on reporting it
                            immediately to our 24-hour call centre, you have zero liability on any fraudulent
                            transactions made on your Credit Card.
                        </li><br>
                        <li>500 Cash Points (applicable only on payment of membership fee).
                        </li><br>
                        <li>
                            Reward Points earned on your HDFC Bank MoneyBack Credit Card are valid only for 2 years from
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{ route('create.moneyback') }}" id="form" enctype="multipart/form-data"  method="POST">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col p-3">
                                            <input type="text" style="text-align: center" class="form-control" name="img_name"
                                                value="Moneyback Credit Card" readonly>
                                        </div>
