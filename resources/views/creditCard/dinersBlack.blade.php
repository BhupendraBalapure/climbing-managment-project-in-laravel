                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "DINERS-BLACK CREDIT CARD", "DINERS-BLACK CREDIT CARD", "DINERS-BLACK CREDIT CARD", "DINERS-BLACK CREDIT CARD", "DINERS-BLACK CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/Diners-Black.png')}}" alt="Diners-Black Credit-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.dinersBlack')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Diners-Black Credit Card" readonly>
                                    </div>
