                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "INDIAN-OIL CREDIT CARD", "INDIAN-OIL CREDIT CARD", "INDIAN-OIL CREDIT CARD", "INDIAN-OIL CREDIT CARD", "INDIAN-OIL CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/indianOil.webp')}}" alt="IndianOil-Card"
                            style="width: 50%;height: 50%;">
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            IndianOil HDFC Bank Credit Card comes with an option to convert your big spends into EMI
                            after purchase.
                        </li><br>
                        <li> Complimentary IndianOil XTRAREWARDSTM Program (IXRP) membership.
                        </li><br>
                        <li>
                            Earn 5% of your spends as Fuel Points at IndianOil outlets (Max 250 Fuel Points per month in
                            first 6 months, Max 150 Fuel Points post 6 months from card issuance)
                        </li><br>
                        <li>
                        ...
                        <li>
                            Interest Free Credit Period : Up to 50 days of interest free period on your IndianOil HDFC
                            Bank Credit Card from the date of purchase (subject to the submission of the charge by the
                            Merchant)
                        </li>
                    </ul>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{route('create.indianOil')}}" id="form" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col p-3">
                                            <input type="text" style="text-align: center" class="form-control" name="img_name"
                                                value="Indian-Oil Credit Card" readonly>
                                        </div>
