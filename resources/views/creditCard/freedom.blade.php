                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "FREEDOM CREDIT CARD", "FREEDOM CREDIT CARD", "FREEDOM CREDIT CARD", "FREEDOM CREDIT CARD", "FREEDOM CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{ asset('assets/img/creditCard/HDFC-Freedom-Card.png') }}" alt="Freedom-Card"
                            style="width: 50%;height: 50%;">
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            HDFC Bank Freedom Credit Card is enabled for contactless payments, facilitating fast,
                            convenient and secure payments at retail outlets.
                        </li> <br>
                        <li> Get a welcome and renewal benefit of 500 reward points on fee realization
                        </li><br>
                        <li>Earn 1 reward point on every spend of ₹150 and above
                        </li><br>
                        <li>
                            Convenience fee waiver of 1%, capped at Rs.250 per statement cycle(Applicable on minimum
                            transaction of Rs.400 and maximum of Rs.5,000 )GST will be applicable
                        </li><br>
                        <li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{ route('create.freedom') }}" id="form" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col p-3">
                                            <input type="text" style="text-align: center" class="form-control"
                                                name="img_name" value="Freedom Credit Card" readonly>
                                        </div>
                                        <div class="row">
