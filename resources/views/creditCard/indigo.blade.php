                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "INDIGO CREDIT CARD", "INDIGO CREDIT CARD", "INDIGO CREDIT CARD", "INDIGO CREDIT CARD", "INDIGO CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/HDFC-Bank-6E-Rewards-IndiGo-HDFC-Bank-Credit-Card-2.png')}}" alt="HDFC-Bank-6E-Rewards-IndiGo-HDFC-Bank-Credit-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                           
6E Rewards - IndiGo HDFC Bank Credit Card comes with an option to convert your big spends into EMI after purchase. 
                        </li> <br>
                        <li>1 Complimentary 6E Prime Add-On (Priority check in, choice of seat, a complimentary meal & quicker baggage)
                        </li><br>
                        <li>6E Rewards - IndiGo HDFC Bank Credit Card is enabled for contactless payments, facilitating fast, convenient and secure payments at retail outlets. 
                        </li><br>
                        <li>
                            Discounted Convenience Fee on IndiGo tickets-Rs.150 per pax(current – Rs.300)
                        </li><br>
                        <li>
                            2% 6E Rewards on Grocery, Dining & Entertainment.
                        </li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.indigo')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Indigo Credit Card" readonly>
                                    </div>
