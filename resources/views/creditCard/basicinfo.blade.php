@extends('businessloan.layouts.default') @include('include.header')
            ...
            <div class="col-md-5">
                ...
                <div class="item-pro">
                    ...
                    <p><a class="" style="color: #594671;font-size: 0.8em;
                                          ">Life Is All About Making Interesting Choices. You May Want To Live Better
                            Every Day Or Enjoy Great Times, Splurge On A Luxurious Indulgence Or Get Excited About
                            Making The First Of Many Purchases, Be Rewarded For Getting Something Or Be Inspired To Do
                            More, Fuel Your Dreams Or Let Them Fly To Global Destinations..</a></p>
                    </a>
                    </p>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                            ...
                            <form action="{{ route('creditCard.createpostbasicinfo') }}" method="POST">
                                @csrf
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" pattern="[789][0-9]{9}" maxlength="10" id="mobile" name="mobile" 
                                                required />
                                        </div>
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-info"
                                            style="background-color: #36c2f8b0">Continue</button>
                                    </div>
                                </div>
                            </form>
                        </div>
