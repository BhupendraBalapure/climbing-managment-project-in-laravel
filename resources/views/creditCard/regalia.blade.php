                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "REGALIA CREDIT CARD", "REGALIA CREDIT CARD", "REGALIA CREDIT CARD", "REGALIA CREDIT CARD", "REGALIA CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/Regalis.webp')}}" alt="Regalia-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                           

                            HDFC Bank Regalia Credit Card comes with an option to convert your big spends into EMI after purchase.
                        </li> <br>
                        <li>The HDFC Bank Regalia Credit Card is enabled for contactless payments, facilitating fast, convenient and secure payments at retail outlets.
                        </li><br>
                        <li>1% fuel surcharge waiver at all fuel stations across India 
                            ( on minimum transaction of ₹400  and maximum transaction of ₹5000 )
                        </li><br>
                        <li>
                            12 Complimentary Airport Lounge Access within India and 6 outside India.
                        </li><br>
                        <li>
                            Bonus 10,000 Reward Points on Rs. 5 lakhs spends and additional 5,000  Reward Points on Rs. 8 lakhs spends in an anniversary year. 
                        </li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.regalia')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Regalia Credit Card" readonly>
                                    </div>
