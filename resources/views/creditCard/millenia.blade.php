                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "MILLENNIA CREDIT CARD", "MILLENNIA CREDIT CARD", "MILLENNIA CREDIT CARD", "MILLENNIA CREDIT CARD", "MILLENNIA CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/Millennia.webp')}}" alt="Millennia-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                           
HDFC Bank Millennia Credit Card comes with an option to convert your big spends into EMI after purchase.
                        </li> <br>
                        <li>5% Cashback Upto A Max Of Rs.750 Per Month On PayZapp & SmartBuy Transactions* | Earn Upto Rs.1000 Cashback For 1st 6 Months Card Issuance.
                        </li><br>
                        <li>Up To 8 Complimentary Domestic Lounge Accesses(Per Calender Year Throght The Freanchise Lounge Program)
                        </li><br>
                        <li>
                            In the unfortunate event of losing your HDFC Bank Millennia Credit Card, on reporting it immediately to our 24-hour call centre, you have zero liability on any fraudulent transactions made on your Credit Card. 
                        </li><br>
                        <li>
                            1% Fuel Surcharge Waiver.(Up To A Maximum Of Rs.250 Per Statement Cycle)    
                        </li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.millenia')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Millenia Credit Card" readonly>
                                    </div>
