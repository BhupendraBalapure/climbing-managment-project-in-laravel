                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "ZENITH CREDIT CARD", "ZENITH CREDIT CARD", "ZENITH CREDIT CARD", "ZENITH CREDIT CARD", "ZENITH CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/Au-bank-credit-Card-Zenith.jpg')}}" alt="Zenith-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            Use your AU Bank Credit Card to make quick, secure & easy payments by just tapping the card and paying at participating merchants without entering Credit Card PIN for amounts up to Rs.5000.
                        </li> <br>
                        <li>In an unfortunate event of loss of Credit Card, you carry zero liability on any fraudulent transactions made with card after reporting the loss to the bank.
                        </li><br>
                        <li>Rs. 1,000 vouchers on minimum Rs.2 lakh retail spends done per calendar quarter. Choose your vouchers from a bouquet of top brands.
                        </li><br>
                        <li>
                            Much lower cross currency foreign mark-up fees of 1.99% applicable on your International transactions.
                        </li><br>
                        <li>
                            2 complimentary lounge access per calendar quarter, using VISA Card at railway stations in these cities – New Delhi, Kolkata (Sealdah), Jaipur, Ahmedabad, Agra and Madurai. For detailed terms & conditions.
                        </li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.zenith')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Zenith Credit Card" readonly>
                                    </div>
