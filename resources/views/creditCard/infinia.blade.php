                ...
                <div class="item-pro">
                    ...
                    <h1>
                        <span class="txt-rotate" style="font-size: 1.8rem" data-period="2000"
                            data-rotate='[ "INFINIA CREDIT CARD", "INFINIA CREDIT CARD", "INFINIA CREDIT CARD", "INFINIA CREDIT CARD", "INFINIA CREDIT CARD" ]'></span>
                    </h1>
                    <div>
                        <img src="{{asset('assets/img/creditCard/infinia.webp')}}" alt="infinia-Card" style="width: 50%;height: 50%;" >
                    </div><br>
                    <ul style="text-align:justify;color: #594671;font-size: 0.8em;">
                        <li>
                            HDFC Bank Infinia Credit Card ccomes with an option to convert your big spends into EMI after purchase.
                        </li> <br>
                        <li> Enjoy unlimited complimentary lounge access at airports within and outside India at 1,000+ airport lounges using Priority Pass.
                        </li><br>
                        <li>Book stay for 3-nights and pay for two at participating ITC hotels.
                        </li><br>
                        <li>
                            Complimentary Club Marriott membership for first year that offers up to 20% discounts for Dining and stay across Asia – Pacific region. 
                        </li><br>
                        <li>
                ...
                <div class="cont " style="margin-top: 7rem; ">
                    <div class="card " style="border-radius: 50px;">
                        <div class="card-body ">
                          ...
                          <form action="{{route('create.infinia')}}" id="form" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col p-3">
                                        <input type="text" style="text-align: center" class="form-control" name="img_name"
                                            value="Infinia Credit Card" readonly>
                                    </div>
