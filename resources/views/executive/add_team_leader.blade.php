    ...
    <main>
        <div class="container">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Add Team Leader Code</li>
            </ol>
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4>Add Team Leader Code</h4>
                        </div>
                        <div class="card-body">
                        ...
                        @endif
                            <form action="{{route('create.add_team_leader')}}" method="post">
                                {{ csrf_field() }}
                               
                                <div class="mb-3">
                                    <label for="team_leader_code">Team Leader Code</label>
                                    <input type="text" name="team_leader_code" class="form-control" id=""/>
                                </div>
